class Twitter:
    ...
    def getNewsFeed(self, userId: int) -> List[int]:
        ...
        res = [] 
        minHeap = [] # [timeOfTweet, tweetId, author/followeeIdOfTweet, nextIndexToConsiderAfterProcessingThisTweet]
        ...
        for followeeId in self.followMap[userId]:
            ...
            if followeeId in self.tweetMap:
                newestTweetIndex = len(self.tweetMap[followeeId]) - 1
                time, tweetId = self.tweetMap[followeeId][newestTweetIndex]
                heapq.heappush(minHeap, [time, tweetId, followeeId, newestTweetIndex - 1]) # index - 1 is the next index to consider 
        ...
        while len(res) < 10 and minHeap: 
            ...
            if index >= 0:
                ...
                heapq.heappush(minHeap, [count, tweetId, followeeId, index - 1]) # next index to consider will not get processed. 
