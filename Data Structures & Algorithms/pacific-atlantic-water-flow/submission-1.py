class Solution:
    def pacificAtlantic(self, heights: List[List[int]]) -> List[List[int]]:
        ...
        # you're just modifying the visit set as you traverse along and pass it along 
        # then we'll compare the two sets at the end with one final pass through the grid. 
