...
class Solution:
    def maxPathSum(self, root: Optional[TreeNode]) -> int:
        ...
        res = root.val # need to remember that this should be initialized to a real value (root.val) instead of 0 because what if the entire tree is negative. need to think about edge cases. 
