    ...
    def maxCoins(self, nums: List[int]) -> int:
        ...
        def dfs(l, r) -> int:
            ...
            for i in range(l, r + 1): # try each position i as the LAST balloon to burst.
                ...
                middle = nums[l - 1] * nums[i] * nums[r + 1] # since we're recursing on interval [l,r], we know that balloons l - 1 and r + 1 are still alive, so that's all thats left for the nums[i] balloon at the end 
